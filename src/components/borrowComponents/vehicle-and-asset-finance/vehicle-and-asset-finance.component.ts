...
@Component({
  ...
  imports: [CommonModule, PageBannerComponent, PageIntroComponent, ImageHeadingCardComponent, FinanceCarouselMobComponent, FinanceCarouselWebComponent, DynamicSwiperComponent, FeaturedCardComponent, BreadcrumbComponent],
